<!-- Experince Modal Edit-->
<div class="modal fade" id="editExpericenceModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog font-end" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body font-end">
          <h2 class="m-title w-100">Edit Experience</h2>
          <form id="editExpericence" method="POST">
            <div class="row">
              <div class="col-xl-12">
                <div class="form-field form-field--is-filled">
                  <div class="form-field__control">
                    <label for="CompanyName" class="form-field__label">Designation</label>
                    <input id="CompanyName" name="designation" type="text" class="form-field__input" />
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="col-xl-6">
                <div class="form-field form-field--is-filled" style="">
                  <div class="form-field__control" style="">
                    ...
                    <input id="Country" name="country" type="text" class="form-field__input" />
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-xl-12">
                <div class="form-field form-field--is-filled">
                  <div class="form-field__control">
                    <label for="CompanyName" class="form-field__label">description</label>
            ...
            <div class="row">
              <div class="form-btn">
                <a class="bg-none-with-border update" href="#" data-dismiss="modal" aria-label="Close">Close</a>
                <a class="btn-theme-btn edit-expericence-submit" href="">Submit</a>
              </div>
            </div>
          </form>
        </div>
