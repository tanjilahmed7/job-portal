    ...
    <div class="modal-dialog font-end modal-dialog-centered" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body font-end">
          <h2 class="m-title w-100">Ask Question</h2>                    
              <form id="ask-form" method="POST">
                  <div class="row">
                      <div class="col-sm">
                          <div class="form-field">
                              <div class="form-field__control">
                                  <label for="write_question"class="form-field__label">Write your Question</label>
                                  <textarea maxlength="150" id="write_question" name="write_question" class="form-field__input" cols="10" rows="5"></textarea>
                                  <div class="ask-text-count float-right"> <span id="count-digit">0</span> / 150 </div>
                              </div>
                          </div>
                      </div>
                  </div>
                  <div class="row">
                      <div class="form-btn w-100">
                          <a href="#" id="ask_submit" class="btn-theme-btn">Submit for Review</a>
                      </div>
                  </div>
              </form>          
