! function (t, e) {
    ...
    function et(t) {
        ue.isVisible() && ot !== t.target.value && ue.resetValidationMessage(), ot = t.target.value
    }
    ...
    function xt(t, e) {
        ...
        y(n, e.customClass, "header"), Bt(0, e),
            ...
            function (t, e) {
                var n = J();
                y(n, e.customClass, "closeButton"), M(n, e.showCloseButton), n.setAttribute("aria-label", e.closeButtonAriaLabel)
            }(0, e)
    }
    ...
    var Mt = [],
        ...
        Ht = ["title", "titleText", "text", "html", "type", "customClass", "showConfirmButton", "showCancelButton", "confirmButtonText", "confirmButtonAriaLabel", "confirmButtonColor", "confirmButtonClass", "cancelButtonText", "cancelButtonAriaLabel", "cancelButtonColor", "cancelButtonClass", "buttonsStyling", "reverseButtons", "imageUrl", "imageWidth", "imageHeigth", "imageAlt", "imageClass", "progressSteps", "currentProgressStep"],
        qt = {
    ...
    function Wt(t, e, n) {
        e ? Yt(n) : (Tt().then(function () {
            return Yt(n)
        }), Vt.keydownTarget.removeEventListener("keydown", Vt.keydownHandler, {
            capture: Vt.keydownListenerCapture
        }), Vt.keydownHandlerAdded = !1), t.parentNode && t.parentNode.removeChild(t), G() && (null !== S.previousBodyPadding && (document.body.style.paddingRight = S.previousBodyPadding + "px", S.previousBodyPadding = null), function () {
    ...
    function Kt(t) {
        ...
        if (e && !b(e, B.hide)) {
            ...
            rt(e, B.show), it(e, B.hide),
                ...
                }(e, r), null !== i && "function" == typeof i && i(e), o(t || {}), Vt.deferDisposalTimer = setTimeout(function () {
                    delete this.params, delete Vt.keydownHandler, delete Vt.keydownTarget, Qt(ht), Qt(Ft)
                }.bind(this), 36e3)
        }
    }
    var Zt = function (e, t, n) {
            Vt.swalClosing = !0, Vt.swalCloseEventFinishedCallback = Wt.bind(null, t, st(), n), e.addEventListener(dt, function (t) {
                t.target === e && Vt.swalClosing && (delete Vt.swalClosing, Vt.swalCloseEventFinishedCallback(), delete Vt.swalCloseEventFinishedCallback)
            })
        },
        Qt = function (t) {
    ...
    function ne(t) {
        var e = H(),
            n = R();
        null !== t.onBeforeOpen && "function" == typeof t.onBeforeOpen && t.onBeforeOpen(n), t.animation && (it(n, B.show), it(e, B.fade)), L(n), dt && j(n) ? (e.style.overflowY = "hidden", n.addEventListener(dt, ee.bind(null, n, e))) : e.style.overflowY = "auto", it([document.documentElement, document.body, e], B.shown), t.heightAuto && t.backdrop && !t.toast && it([document.documentElement, document.body], B["height-auto"]), G() && (t.scrollbarPadding && Nt(), function () {
            ...
            e.scrollTop = 0
        })), st() || Vt.previousActiveElement || (Vt.previousActiveElement = document.activeElement), null !== t.onOpen && "function" == typeof t.onOpen && setTimeout(function () {
            t.onOpen(n)
        })
    }
    var oe = {
    ...
    var re, ae = Object.freeze({
        ...
        _main: function (t) {
            ...
            ! function (t) {
                ...
                var n, o, i
            }(t), Vt.swalClosing && (delete Vt.swalClosing, Vt.swalCloseEventFinishedCallback(), delete Vt.swalCloseEventFinishedCallback), Vt.deferDisposalTimer && (clearTimeout(Vt.deferDisposalTimer), delete Vt.deferDisposalTimer);
            var l = a({}, jt, t);
            ...
            return new Promise(function (t) {
                ...
                }(c, l), ne(l), l.toast || (C(l.allowEnterKey) ? l.focusCancel && V(d.cancelButton) ? d.cancelButton.focus() : l.focusConfirm && V(d.confirmButton) ? d.confirmButton.focus() : a(-1, 1) : document.activeElement && "function" == typeof document.activeElement.blur && document.activeElement.blur()), d.container.scrollTop = 0
            })
        },
        update: function (e) {
            var n = {};
    ...
    function se() {
        if ("undefined" != typeof window) {
            "undefined" == typeof Promise && g("This package requires a Promise library, please include a shim to enable it in this browser (See: https://github.com/sweetalert2/sweetalert2/wiki/Migration-from-SweetAlert-to-SweetAlert2#1-ie-support)"), re = this;
            for (var t = arguments.length, e = new Array(t), n = 0; n < t; n++) e[n] = arguments[n];
    ...
    }, a(se.prototype, ae), a(se, Rt), Object.keys(ae).forEach(function (e) {
        se[e] = function () {
            var t;
            if (re) return (t = re)[e].apply(t, arguments)
        }
    }), se.DismissReason = k, se.version = "8.13.4";
    var ue = se;
